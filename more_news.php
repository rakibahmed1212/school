...
<div class="column2" style="padding:0px 50px 100px 50px; margin: 50px;">
		...
		<?php $notice=$con->query("SELECT * FROM sms_news_event"); 
		while($ndata=$notice->fetch_object()):
	  ?>
        <li>
          <p><strong><a href="single_notice.php?not_id=<?php echo $ndata->id;  ?>"><?php echo $ndata->news_title;  ?></a></strong></p>
		  <div class="imgholder"><?php echo $ndata->created_at;  ?></div>
      <?php   $less_content=array_slice((explode(' ',$ndata->descreption )),0,30); ?>
